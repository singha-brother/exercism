...
def fix_list_of_wagons(each_wagons_id, missing_wagons):
    ...
    :return: list - list of wagons.
    """
    id1, id2, *rest = each_wagons_id
    return [1, *missing_wagons, *[id for id in rest if id > 1], id1, id2]


# TODO: define the 'add_missing_stops()' function
def add_missing_stops(stop_dict, **kwargs):
    ...
    """
    return {**stop_dict, **{"stops": list(kwargs.values())}}
